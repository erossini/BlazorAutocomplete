...
For more details about this component, please see this post on [PureSourceCode.com](https://www.puresourcecode.com/dotnet/net-core/autocomplete-component-for-blazor/). If you need support for this component or you have a suggestion or comment, please use my [Forum](https://www.puresourcecode.com/forum/autocomplete-blazor/).
...
- `PreventDefault` (Optional - Default: `false`) - Control the PreventDefault behavior of the input of this component. See [Microsoft document](https://docs.microsoft.com/en-us/aspnet/core/blazor/components?view=aspnetcore-3.1#prevent-default-actions)
- `ResultContainerCSS` (Optional) - Add a custom CSS class to container of the result box
- `ResultItemCSS` (Optional) - Add a custom CSS class to each item container in the result box
